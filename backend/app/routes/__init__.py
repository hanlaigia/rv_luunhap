...
from backend.app.routes.host.support import support_bp
...
__all__ = ["main_bp", "accommodation_bp", "promotion_bp", "booking_bp", "report_bp", "dispute_bp", "payment_bp", "message_bp", "support_bp", "customer_bp", "customer_booking_bp", "auth_bp", "admin_bp"]
...
def register_blueprints(app):
    ...
    app.register_blueprint(support_bp, url_prefix="/host/support")
